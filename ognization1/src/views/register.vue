                ...
                <div class="row mb-5 justify-content-center text-center">
                    ...
                    <el-card body-style="padding:0">
                        ...
                        <div class="header-btn">
                            <el-radio-group v-model="userRegisterBo.regType" @change="chanceSelect">
                                <el-radio-button value="STUDENT">
                                    <!-- 无法修改el-radio-button的高度,用块级元素撑起内容 -->
                                    <div class="radio-left-content">学生登录</div>
                                </el-radio-button>
                                <el-radio-button value="TEACHER">
                                    <div class="radio-right-content">教师登录</div>
                                </el-radio-button>
                            </el-radio-group>
                        </div>
                            ...
                            <div>
                                ...
                                <el-form ref="ruleFormRef" :model="userRegisterBo" :rules="rules" label-width="auto"
                                    ...
                                    <el-form-item label="密码" prop="password">
                                        <el-input v-model="userRegisterBo.passwd"
    ...
    confirmPassword: [
        ...
        { min: 3, max: 20, message: '长度在3-20个字符', trigger: 'blur' },
        {
            validator: (rule, value, callback) => {
                ...
                } else if (value !== userRegisterBo.passwd) {
...
function resetUserRegisterBo() {
    ...
    userRegisterBo.passwd = '';
    userRegisterBo.regType = '',
        userRegisterBo.studentId = '';
    userRegisterBo.confirmPassword = '';

}
//选择老师或学生的事件
const chanceSelect = (event: any) => {
    userRegisterBo.regType = event
